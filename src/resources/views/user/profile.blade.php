...
<div class="max-w-3xl mx-auto mt-8">
    ...
    <div class="bg-white shadow rounded-lg p-6 space-y-4">
        ...
        <div class="flex items-center space-x-4 items-center justify-center">
            @if($user->avatar)
            <img src="{{ $user->avatar }}" alt="Profile Picture" class="w-24 h-24 rounded-full shadow-md">
            @else
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
            ...
            <div>
                ...
                <p class="text-gray-800">{{ $user->created_at->locale('th')->translatedFormat('d F Y') }}</p>
            </div>
            <div>
